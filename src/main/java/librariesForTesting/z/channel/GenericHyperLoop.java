...
/**
 * Generic variant of {@link librariesForTesting.z.channel.LongHyperLoop}
 */
...
//  private final long addrBuffer;
  ...
  public librariesForTesting.z.channel.ReceivePort<T> createReceivePort() {
   ...
   */
  public final class OutPort<T> implements librariesForTesting.z.channel.ReceivePort<T> {
