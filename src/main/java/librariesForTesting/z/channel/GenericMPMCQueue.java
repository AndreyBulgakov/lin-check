...
package librariesForTesting.z.channel;

import static librariesForTesting.z.util.Contracts.contract;
import static librariesForTesting.z.util.Unsafes.*;


/**
 * Generic variant of {@link librariesForTesting.z.channel.MPMCQueue}.
 *
 */
...
//  private final long addrMarkBuffer;
  ...
  /**
   * To add one long value to current {@link librariesForTesting.z.channel.GenericMPMCQueue}.
   * The added long value will stored in the {@link librariesForTesting.z.channel.GenericMPMCQueue}
   * in FIFO order.
   * <p>
   * @return - true if successfully added to the currrent
   *           {@link librariesForTesting.z.channel.GenericMPMCQueue},
   *           or false if currrent {@link librariesForTesting.z.channel.GenericMPMCQueue}
   *           is full.
   */
   ...
   * <p>
   * @return - one long value if currrent {@link librariesForTesting.z.channel.GenericMPMCQueue}
   *           holds at least one value,
   *           or null if currrent {@link librariesForTesting.z.channel.GenericMPMCQueue}
