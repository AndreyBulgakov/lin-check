...
package librariesForTesting.z.offheap.buffer;

import static librariesForTesting.z.offheap.zmalloc.Allocator.*;
import static librariesForTesting.z.offheap.buffer.Buffers.*;
import static librariesForTesting.z.util.Contracts.*;

/**
* Buffer, is one kind off-heap memory storage based on
* {@link librariesForTesting.z.offheap.zmalloc.Allocator}.
* <p>
* Note:
...
public class Buffer implements
   ...
   *          contain garbage, in that {@link librariesForTesting.z.offheap.buffer.Buffer} does not
